    ...
    <div className="space-y-6">
      ...
      <Modal isOpen={showCreate} onClose={() => { setShowCreate(false); if (clearCreateModal) clearCreateModal(); }} title="Create New Referral">
        <div className="space-y-4">
          ...
          <div><label className="block text-sm font-medium text-slate-700 mb-1">Notes</label><textarea value={newRef.notes} onChange={e => setNewRef({ ...newRef, notes: e.target.value })} className="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 h-24 resize-none" placeholder="Add context about this referral..." /></textarea></div>
